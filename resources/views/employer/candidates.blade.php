                ...
                <tr>
                    ...
                    <th scope="col">
                        <a href="{{ route('candidates.index') }}" target="_blank" rel="noopener noreferrer"
                            title="more candidates">More Candidates
                        ...
                        <tr class="">
                            <td scope="row">
                                <div class="d-flex flex-wrap align-items-center">
                                    <img src="{{ $candidate->candidate->dp ?? asset('icons/avatar-png.png') }}"
                            ...
                            <td>
                                <div class="d-flex flex-row flex-wrap align-items-center justify-content-end">
                                    ...
                                    <a href="{{ route('candidate.profile-info', $candidate->candidate->user->username) }}"
                                        target="_blacnk" rel="noopener noreferrer" class="btn btn-primary">
                                        view profile
                                    </a>
                                </div>
                            </td>
