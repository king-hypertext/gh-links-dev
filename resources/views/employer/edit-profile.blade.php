...
@section('content')
    ...
    <ul class="nav nav-tabs mb-3" id="account-setup" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a data-mdb-tab-init class="nav-link" id="account-setup-tab-3" href="#account-setup-3" role="tab"
                aria-controls="account-setup-3" aria-selected="false">
    ...
    <div class="tab-content" id="account-setup-content">
        ...
        <div class="tab-pane fade" id="account-setup-3" role="tabpanel" aria-labelledby="account-setup-tab-3">
            Tab 3 content
        </div>
    </div>
    <!-- Tabs content -->
