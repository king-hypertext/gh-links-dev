...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        <form id="profile-setup" action="{{ route('candidate.profile.store') }}" enctype="multipart/form-data"
            method="post">
            @csrf
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <input required type="text" value="{{ $candidate->profile?->location }}" class="form-control" name="location"
                        id="location" />
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-6">
                    ...
                    <input required type="file" class="form-control form-file-input" name="profile_picture" id="profile_picture"
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-4">
                    <label for="first_name">Institution Cycle <span class="text-danger fw-bold">*</span></label>
                    <select required name="gender" id="gender" class="form-select">
                ...
                <div class="col-sm-4">
                    ...
                    <input required type="date" max="{{ Date('Y-m-d') }}"
                        value="{{ $candidate->profile?->education?->started_at }}" class="form-control"
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text"
                        class="form-control"value="{{ $candidate->profile?->job_experience?->location }}" name="location"
                        id="location" />
                </div>
                <div class="col-sm-4">
        ...
        <div>
            <script>
                $(document).ready(function() {
                    $('#profile-setup').on('submit', function(e) {
                        $('#profile-setup :submit').addClass('disabled').html(
                            `<span id="btn-icon" class="fas fa-spinner fa-spin me-2"></span> saving data...`);
                        return 1;
                    });
                    tinymce.init({
